...
test.describe('тесты главной страницы', () => {
  //используем группировку тестов
  test.beforeEach(async ({ page }) => {
    //используем хук beforeEach для предусловия запуска тестов
    await page.goto('https://playwright.dev/');
  });
  test('Проверка отображения элементов навигации HEADERS', async ({ page }) => {
  ...
  test('Проверка корректности названия элементов навигации HEADERS', async ({ page }) => {
  ...
  test('Проверка атрибутов href элементов навигации HEADERS', async ({ page }) => {
  ...
  test('Проверка переключения Light мода (смена режима отображения со светлого на темный)', async ({
    page,
  }) => {
  ...
  test('Проверка кнопки Get started с мягким утверждением .soft', async ({ page }) => {
